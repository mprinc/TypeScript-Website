...
With more `tsconfig.json` files, you'll usually want to use [Configuration file inheritance](/docs/handbook/tsconfig-json.html) to <span class='definition'centralize your common compiler options</span>.
