...
`--moduleResolution`                           | `string`  | `module === "AMD" or "UMD" or "System" or "ES6" ?  "Classic" : "Node"`   | Determine <span class='definition'>how modules get resolved</span>. Either `"Node"` for Node.js/io.js style resolution, or `"Classic"`. See [Module Resolution documentation](/docs/handbook/module-resolution.html) for more details.
...
`--preserveConstEnums`                         | `boolean` | `false`                        | <span class='important'>Do not erase const enum declarations</span> in generated code. See [const enums documentation](/docs/handbook/enums.html#const-enums) for more details.
